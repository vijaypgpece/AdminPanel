...
--
-- Host: localhost:3306
-- Generation Time: Sep 16, 2023 at 04:20 AM
...
--
-- Table structure for table `resume_certification`
--

CREATE TABLE `resume_certification` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Table structure for table `resume_education1`
--

CREATE TABLE `resume_education1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Table structure for table `resume_experience1`
--

CREATE TABLE `resume_experience1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
  ...
  `worked_Until` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `resume_experience1`
--

INSERT INTO `resume_experience1` (`id`, `Profile_ID`, `Company_Name`, `Company_Location`, `Designation`, `Worked_From`, `worked_Until`) VALUES
(1, 1, 'PGP Group of Institutions', 'Namakkal,TN,India.', 'Assistant Professor', '2016-02-12', '0000-00-00'),
(2, 1, 'Sri Ramakrishna Engineering College', 'Sri Ramakrishna Engineering College', 'Assistant Professor', '2023-04-06', '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `resume_experience_roles1`
--

CREATE TABLE `resume_experience_roles1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
  `company_id_experience` bigint(10) NOT NULL,
  `roles_and_responsibilities` varchar(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `resume_experience_roles1`
--

INSERT INTO `resume_experience_roles1` (`id`, `Profile_ID`, `company_id_experience`, `roles_and_responsibilities`) VALUES
(1, 1, 1, 'Class In-Charge for final Year students.'),
(2, 1, 1, 'Industrial Visit Co-Ordinator.');

-- --------------------------------------------------------

--
-- Table structure for table `resume_header1`
--

CREATE TABLE `resume_header1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Dumping data for table `resume_header1`
--

INSERT INTO `resume_header1` (`id`, `Profile_ID`, `First_Name`, `Last_Name`, `Address`, `Phone_no`, `Email`) VALUES
(4, 1, 'vijay', 'A', '170- Alwin Nagar\nCovai road , Karur', '07667825011', 'vijaypgpece@gmail.com');
...
--
-- Dumping data for table `resume_hobbies`
--

INSERT INTO `resume_hobbies` (`id`, `Profile_ID`, `Hobbies`) VALUES
(1, 1, 'Swimming');

-- --------------------------------------------------------

--
-- Table structure for table `resume_languages1`
--

CREATE TABLE `resume_languages1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Dumping data for table `resume_languages1`
--

INSERT INTO `resume_languages1` (`id`, `Profile_ID`, `Languages`, `CEFR`) VALUES
(1, 1, 'Chinese', 'C2');

-- --------------------------------------------------------

--
-- Table structure for table `resume_skillhighlights1`
--

CREATE TABLE `resume_skillhighlights1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
  `SkillHighlights` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `resume_skillhighlights1`
--

INSERT INTO `resume_skillhighlights1` (`id`, `Profile_ID`, `SkillHighlights`) VALUES
(15, 1, 'hello vijay jijij'),
(16, 0, 'hello vijay'),
(17, 1, 'hi how r you '),
(18, 1, 'hello naviya'),
(19, 1, '2222'),
...
--
-- Table structure for table `resume_social_networking`
--

CREATE TABLE `resume_social_networking` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Dumping data for table `resume_social_networking`
--

INSERT INTO `resume_social_networking` (`id`, `Profile_ID`, `Social_Network`, `URL`) VALUES
(1, 1, 'Facebook', 'https://www.facebook.com/'),
(3, 1, 'Twitter', 'https://www.twitter.com/');

-- --------------------------------------------------------

--
-- Table structure for table `resume_software`
--

CREATE TABLE `resume_software` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Dumping data for table `resume_software`
--

INSERT INTO `resume_software` (`id`, `Profile_ID`, `Software`) VALUES
(1, 1, 'Adobe Photoshop'),
...
--
-- Table structure for table `resume_summary1`
--

CREATE TABLE `resume_summary1` (
  `id` bigint(10) NOT NULL,
  `Profile_ID` bigint(10) NOT NULL,
...
--
-- Dumping data for table `resume_summary1`
--

INSERT INTO `resume_summary1` (`id`, `Profile_ID`, `Summary`) VALUES
(6, 1, 'To work for an organization which provides me the opportunity to improve my skills and knowledge to growth along with the organization objective. An enthusiastic fresher with highly motivated and leadership skills having bachelors of engineering degree in Mechanical Engineering.');
...
--
-- Indexes for table `resume_certification`
--
ALTER TABLE `resume_certification`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_education1`
--
ALTER TABLE `resume_education1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_experience1`
--
ALTER TABLE `resume_experience1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_experience_roles1`
--
ALTER TABLE `resume_experience_roles1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_header1`
--
ALTER TABLE `resume_header1`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `contacts_unique` (`Profile_ID`);

--
-- Indexes for table `resume_hobbies`
--
ALTER TABLE `resume_hobbies`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_languages1`
--
ALTER TABLE `resume_languages1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_skillhighlights1`
--
ALTER TABLE `resume_skillhighlights1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_social_networking`
--
ALTER TABLE `resume_social_networking`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_software`
--
ALTER TABLE `resume_software`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `resume_summary1`
--
ALTER TABLE `resume_summary1`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `contacts_unique` (`Profile_ID`);
...
--
-- AUTO_INCREMENT for table `resume_certification`
--
ALTER TABLE `resume_certification`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `resume_education1`
--
ALTER TABLE `resume_education1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `resume_experience1`
--
ALTER TABLE `resume_experience1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `resume_experience_roles1`
--
ALTER TABLE `resume_experience_roles1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `resume_header1`
--
ALTER TABLE `resume_header1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `resume_hobbies`
--
ALTER TABLE `resume_hobbies`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `resume_languages1`
--
ALTER TABLE `resume_languages1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `resume_skillhighlights1`
--
ALTER TABLE `resume_skillhighlights1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `resume_social_networking`
--
ALTER TABLE `resume_social_networking`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `resume_software`
--
ALTER TABLE `resume_software`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `resume_summary1`
--
ALTER TABLE `resume_summary1`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
